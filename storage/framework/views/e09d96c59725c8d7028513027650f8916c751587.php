    ...
    <div class="ndnhanvien">
        <div class="noidungthemmoi">
            ...
            <form method="POST" action=" <?php echo e(url('nvdangnhap')); ?>">
                ...
                <?php if(session('tkthatbai')): ?>
                    <div class="alert alert-danger text-xs-center"><?php echo e(session('tkthatbai')); ?></div>
                <?php elseif(session('mkthatbai')): ?>
                    <div class="alert alert-danger text-xs-center"><?php echo e(session('mkthatbai')); ?></div>
                <?php endif; ?>
